...
# Unit tests for Intrinio::DataTag
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DataTag' do
  before do
    # run before each test
    @instance = Intrinio::DataTag.new
  end
  ...
  describe 'test an instance of DataTag' do
    it 'should create an instance of DataTag' do
      expect(@instance).to be_instance_of(Intrinio::DataTag)
    end
  end
