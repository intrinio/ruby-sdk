...
# Unit tests for Intrinio::OptionIntervalMover
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OptionIntervalMover' do
  before do
    # run before each test
    @instance = Intrinio::OptionIntervalMover.new
  end
  ...
  describe 'test an instance of OptionIntervalMover' do
    it 'should create an instance of OptionIntervalMover' do
      expect(@instance).to be_instance_of(Intrinio::OptionIntervalMover)
    end
  end
