...
describe 'StockExchangeApi' do
  ...
  # unit tests for get_stock_exchange_price_adjustments_dividends
  ...
  # @option opts [String] :next_page Gets the next page of data from a previous API call
  # @return [ApiResponseStockExchangeStockPriceAdjustments]
  describe 'get_stock_exchange_price_adjustments_dividends test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_stock_exchange_price_adjustments_splits
  ...
  # @option opts [String] :next_page Gets the next page of data from a previous API call
  # @return [ApiResponseStockExchangeStockPriceAdjustments]
  describe 'get_stock_exchange_price_adjustments_splits test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
