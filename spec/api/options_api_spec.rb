...
describe 'OptionsApi' do
  ...
  # unit tests for get_options_greeks_by_contract
  ...
  describe 'get_options_greeks_by_contract test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_options_greeks_by_ticker
  ...
  describe 'get_options_greeks_by_ticker test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
