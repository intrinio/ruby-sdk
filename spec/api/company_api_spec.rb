...
describe 'CompanyApi' do
  ...
  # @option opts [String] :fundamental_type Only of the given fundamental type
  ...
  # @option opts [BOOLEAN] :latest_only Only the most-recently reported fundamental for the period
  ...
  # unit tests for get_company_news_body
  # News Article Body
  ...
  describe 'get_company_news_body test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
