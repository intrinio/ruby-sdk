...
describe 'CompanyApi' do
  ...
  # unit tests for get_all_company_filings
  # Filings
  ...
  describe 'get_all_company_filings test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_all_company_fundamentals
  ...
  # @option opts [String] :next_page Gets the next page of data from a previous API call
  # @return [Array<Fundamental>]
  describe 'get_all_company_fundamentals test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
