...
# Unit tests for Intrinio::MarketApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketApi' do
  before do
    # run before each test
    @instance = Intrinio::MarketApi.new
  end
  ...
  describe 'test an instance of MarketApi' do
    it 'should create an instance of MarketApi' do
      expect(@instance).to be_instance_of(Intrinio::MarketApi)
    end
  end

  # unit tests for get_market_status
  # Market Status
  # Returns the market status.
  # @param [Hash] opts the optional parameters
  # @return [MarketStatusResult]
  describe 'get_market_status test' do
    it "should work" do
