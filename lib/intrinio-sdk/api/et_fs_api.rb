...
module Intrinio
  class ETFsApi
    ...
    # @param identifier An ETF identifier (Ticker, Figi Ticker, ISIN, RIC, Intrinio ID)
    # @param [Hash] opts the optional parameters
    # @option opts [Date] :start_date The start date for the historical stats data in YYYY-MM-DD format.
    # @option opts [Date] :end_date The end date for the historical stats data in YYYY-MM-DD format.
    ...
    # @return [Array<(ETFHistoricalStats, Fixnum, Hash)>] ETFHistoricalStats data, response status code and response headers
