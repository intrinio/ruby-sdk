...
module Intrinio
  class FundamentalsApi
    ...
    # @param id The Intrinio ID for the Fundamental
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<ReportedFinancial>, Fixnum, Hash)>] Array<ReportedFinancial> data, response status code and response headers
    def get_fundamental_reported_financials_with_http_info(id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<ReportedFinancial>')
      if @api_client.config.debugging
    ...
    # @param id The Intrinio ID for the Fundamental
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<StandardizedFinancial>, Fixnum, Hash)>] Array<StandardizedFinancial> data, response status code and response headers
    def get_fundamental_standardized_financials_with_http_info(id, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<StandardizedFinancial>')
      if @api_client.config.debugging
