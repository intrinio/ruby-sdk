...
module Intrinio
  class OptionsApi
    ...
    def get_option_strikes_realtime_with_http_info(symbol, strike, opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'stock_price_source'] && !['iex', 'bats_delayed', 'intrinio_mx', 'intrinio_mx_plus', 'delayed_sip', 'utp_delayed', 'otc_delayed', 'cta_a_delayed', 'cta_b_delayed', 'nasdaq_basic'].include?(opts[:'stock_price_source'])
        fail ArgumentError, 'invalid value for "stock_price_source", must be one of iex, bats_delayed, intrinio_mx, intrinio_mx_plus, delayed_sip, utp_delayed, otc_delayed, cta_a_delayed, cta_b_delayed, nasdaq_basic'
      end
    ...
    def options_greeks_by_ticker_identifier_realtime_get(identifier, opts = {})
      data, _status_code, _headers = options_greeks_by_ticker_identifier_realtime_get_with_http_info(identifier, opts)
      return data
    end
    ...
    def options_greeks_by_ticker_identifier_realtime_get_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OptionsApi.options_greeks_by_ticker_identifier_realtime_get ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling OptionsApi.options_greeks_by_ticker_identifier_realtime_get"
      end
      if @api_client.config.client_side_validation && opts[:'source'] && !['realtime', 'delayed'].include?(opts[:'source'])
        fail ArgumentError, 'invalid value for "source", must be one of realtime, delayed'
      end
      ...
      if @api_client.config.client_side_validation && opts[:'stock_price_source'] && !['iex', 'nasdaq_basic', 'nasdaq_basic_last_sale', 'bats_delayed', 'utp_delayed', 'cta_a_delayed', 'cta_b_delayed', 'otc_delayed', 'delayed_sip'].include?(opts[:'stock_price_source'])
        fail ArgumentError, 'invalid value for "stock_price_source", must be one of iex, nasdaq_basic, nasdaq_basic_last_sale, bats_delayed, utp_delayed, cta_a_delayed, cta_b_delayed, otc_delayed, delayed_sip'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 2500
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling OptionsApi.options_greeks_by_ticker_identifier_realtime_get, must be smaller than or equal to 2500.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OptionsApi#options_greeks_by_ticker_identifier_realtime_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def options_greeks_contract_realtime_get(contract, opts = {})
      data, _status_code, _headers = options_greeks_contract_realtime_get_with_http_info(contract, opts)
      return data
    end
    ...
    def options_greeks_contract_realtime_get_with_http_info(contract, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: OptionsApi.options_greeks_contract_realtime_get ..."
      end
      # verify the required parameter 'contract' is set
      if @api_client.config.client_side_validation && contract.nil?
        fail ArgumentError, "Missing the required parameter 'contract' when calling OptionsApi.options_greeks_contract_realtime_get"
      end
      if @api_client.config.client_side_validation && opts[:'source'] && !['realtime', 'delayed'].include?(opts[:'source'])
        fail ArgumentError, 'invalid value for "source", must be one of realtime, delayed'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OptionsApi#options_greeks_contract_realtime_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
