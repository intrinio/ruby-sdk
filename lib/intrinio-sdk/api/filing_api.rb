...
module Intrinio
  class FilingApi
    ...
    # @option opts [BOOLEAN] :earnings_release Return filings that have been tagged as having Results of Operations and Financial Conditions
    ...
    def get_all_filings_with_http_info(opts = {})
      ...
      query_params[:'earnings_release'] = opts[:'earnings_release'] if !opts[:'earnings_release'].nil?
