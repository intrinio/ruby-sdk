...
module Intrinio
  class HistoricalDataApi
    ...
    def get_historical_data(identifier, item, opts = {})
      data, _status_code, _headers = get_historical_data_with_http_info(identifier, item, opts)
      return data
    end
    ...
    def get_historical_data_with_http_info(identifier, item, opts = {})
      ...
      if @api_client.config.client_side_validation && item.nil?
        fail ArgumentError, "Missing the required parameter 'item' when calling HistoricalDataApi.get_historical_data"
      end
      if @api_client.config.client_side_validation && opts[:'sort_order'] && !['asc', 'desc'].include?(opts[:'sort_order'])
        fail ArgumentError, 'invalid value for "sort_order", must be one of asc, desc'
      end
      # resource path
      local_var_path = "/historical_data/{identifier}/{item}".sub('{' + 'identifier' + '}', identifier.to_s).sub('{' + 'item' + '}', item.to_s)
