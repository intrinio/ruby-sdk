...
module Intrinio
  class SecurityApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(Array<SecuritySummary>, Fixnum, Hash)>] Array<SecuritySummary> data, response status code and response headers
    def get_all_securities_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<SecuritySummary>')
      if @api_client.config.debugging
    ...
    def get_security_data_point_number(identifier, item, opts = {})
      data, _status_code, _headers = get_security_data_point_number_with_http_info(identifier, item, opts)
      return data
    end
    ...
    def get_security_data_point_number_with_http_info(identifier, item, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && item.nil?
        fail ArgumentError, "Missing the required parameter 'item' when calling SecurityApi.get_security_data_point_number"
      end
      # resource path
      local_var_path = "/securities/{identifier}/data_point/{item}/number".sub('{' + 'identifier' + '}', identifier.to_s).sub('{' + 'item' + '}', item.to_s)
    ...
    def get_security_data_point_text(identifier, item, opts = {})
      data, _status_code, _headers = get_security_data_point_text_with_http_info(identifier, item, opts)
      return data
    end
    ...
    def get_security_data_point_text_with_http_info(identifier, item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'item' is set
      if @api_client.config.client_side_validation && item.nil?
        fail ArgumentError, "Missing the required parameter 'item' when calling SecurityApi.get_security_data_point_text"
      end
      # resource path
      local_var_path = "/securities/{identifier}/data_point/{item}/text".sub('{' + 'identifier' + '}', identifier.to_s).sub('{' + 'item' + '}', item.to_s)
    ...
    def get_security_historical_data(identifier, item, opts = {})
      data, _status_code, _headers = get_security_historical_data_with_http_info(identifier, item, opts)
      return data
    end
    ...
    def get_security_historical_data_with_http_info(identifier, item, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'item' is set
      if @api_client.config.client_side_validation && item.nil?
        fail ArgumentError, "Missing the required parameter 'item' when calling SecurityApi.get_security_historical_data"
      end
      if @api_client.config.client_side_validation && opts[:'sort_order'] && !['asc', 'desc'].include?(opts[:'sort_order'])
        fail ArgumentError, 'invalid value for "sort_order", must be one of asc, desc'
      end
      # resource path
      local_var_path = "/securities/{identifier}/historical_data/{item}".sub('{' + 'identifier' + '}', identifier.to_s).sub('{' + 'item' + '}', item.to_s)
    ...
    # @option opts [Date] :end_date Return prices on or beore the date
    # @option opts [String] :frequency Return stock prices in the given frequency (default to daily)
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<StockPriceSummary>]
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(Array<StockPriceSummary>, Fixnum, Hash)>] Array<StockPriceSummary> data, response status code and response headers
    def get_security_stock_prices_with_http_info(identifier, opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'Array<StockPriceSummary>')
      if @api_client.config.debugging
