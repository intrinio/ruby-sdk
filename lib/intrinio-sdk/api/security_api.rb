...
module Intrinio
  class SecurityApi
    ...
    # @option opts [Integer] :page_size The number of results to return (default to 100)
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @option opts [Date] :date Return dividend records on or before this date. Format YYYY-MM-DD
    # @option opts [String] :identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
    ...
    def get_securities_latest_dividend_records(opts = {})
      data, _status_code, _headers = get_securities_latest_dividend_records_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
    # @option opts [String] :next_page2 Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecuritiesDividendLatest, Fixnum, Hash)>] ApiResponseSecuritiesDividendLatest data, response status code and response headers
    def get_securities_latest_dividend_records_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_securities_latest_dividend_records ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 10000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SecurityApi.get_securities_latest_dividend_records, must be smaller than or equal to 10000.'
      end

      # resource path
      local_var_path = "/securities/dividends/latest"
      ...
      query_params[:'identifiers'] = opts[:'identifiers'] if !opts[:'identifiers'].nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_securities_latest_dividend_records\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Integer] :page_size The number of results to return (default to 100)
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @option opts [Date] :date Return earnings records on or before this date. Format YYYY-MM-DD
    # @option opts [String] :identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
    # @option opts [String] :next_page2 Gets the next page of data from a previous API call
    # @return [ApiResponseSecuritiesEarningsLatest]
    def get_securities_latest_earnings_records(opts = {})
      data, _status_code, _headers = get_securities_latest_earnings_records_with_http_info(opts)
      return data
    end
    ...
    # @option opts [String] :identifiers A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
    # @option opts [String] :next_page2 Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecuritiesEarningsLatest, Fixnum, Hash)>] ApiResponseSecuritiesEarningsLatest data, response status code and response headers
    def get_securities_latest_earnings_records_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_securities_latest_earnings_records ..."
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 10000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SecurityApi.get_securities_latest_earnings_records, must be smaller than or equal to 10000.'
      end

      # resource path
      local_var_path = "/securities/earnings/latest"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_securities_latest_earnings_records\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_securities_short_interest(opts = {})
      data, _status_code, _headers = get_securities_short_interest_with_http_info(opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecuritiesShortInterest, Fixnum, Hash)>] ApiResponseSecuritiesShortInterest data, response status code and response headers
    def get_securities_short_interest_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_securities_short_interest ..."
      end
      # resource path
      local_var_path = "/securities/short_interest"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_securities_short_interest\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_security_history_by_identifier(identifier, opts = {})
      data, _status_code, _headers = get_security_history_by_identifier_with_http_info(identifier, opts)
      return data
    end
    ...
    # @param identifier A Security identifier (FIGI, COMPOSITE FIGI, SHARE CLASS FIGI, ISIN, CUSIP, Intrinio ID)
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecurityHistoryListResult, Fixnum, Hash)>] SecurityHistoryListResult data, response status code and response headers
    def get_security_history_by_identifier_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_history_by_identifier ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling SecurityApi.get_security_history_by_identifier"
      end
      # resource path
      local_var_path = "/securities/history-by-identifier/{identifier}".sub('{' + 'identifier' + '}', identifier.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_history_by_identifier\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [SecurityHistoryListResult]
    def get_security_history_by_ticker(ticker, opts = {})
      data, _status_code, _headers = get_security_history_by_ticker_with_http_info(ticker, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecurityHistoryListResult, Fixnum, Hash)>] SecurityHistoryListResult data, response status code and response headers
    def get_security_history_by_ticker_with_http_info(ticker, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_history_by_ticker ..."
      end
      # verify the required parameter 'ticker' is set
      if @api_client.config.client_side_validation && ticker.nil?
        fail ArgumentError, "Missing the required parameter 'ticker' when calling SecurityApi.get_security_history_by_ticker"
      end
      # resource path
      local_var_path = "/securities/history-by-ticker/{ticker}".sub('{' + 'ticker' + '}', ticker.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'SecurityHistoryListResult')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_history_by_ticker\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecurityInstitutionalOwnership, Fixnum, Hash)>] ApiResponseSecurityInstitutionalOwnership data, response status code and response headers
    ...
    # @option opts [String] :source Realtime or 15-minute delayed contracts.
    # @option opts [DateTime] :open_time The inclusive UTC date and time the interval opens at.
    # @return [Array<(SecurityIntervalsMoversResult, Fixnum, Hash)>] SecurityIntervalsMoversResult data, response status code and response headers
    def get_security_interval_movers_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'source'] && !['realtime', 'delayed', 'nasdaq_basic', 'nasdaq_basic_filtered', 'nasdaq_basic_last_sale', 'cboe_one_delayed', 'iex', 'iex_delayed'].include?(opts[:'source'])
        fail ArgumentError, 'invalid value for "source", must be one of realtime, delayed, nasdaq_basic, nasdaq_basic_filtered, nasdaq_basic_last_sale, cboe_one_delayed, iex, iex_delayed'
      end
      # resource path
    ...
    def get_security_interval_prices_with_http_info(identifier, interval_size, opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'source'] && !['realtime', 'delayed', 'nasdaq_basic', 'nasdaq_basic_filtered', 'nasdaq_basic_last_sale', 'cboe_one', 'equities_edge'].include?(opts[:'source'])
        fail ArgumentError, 'invalid value for "source", must be one of realtime, delayed, nasdaq_basic, nasdaq_basic_filtered, nasdaq_basic_last_sale, cboe_one, equities_edge'
      end
    ...
    def get_security_quote(identifier, opts = {})
      data, _status_code, _headers = get_security_quote_with_http_info(identifier, opts)
      return data
    end
    ...
    def get_security_quote_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_quote ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_quote\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param date The date for the data being requested.
    # @param [Hash] opts the optional parameters
    # @return [Array<(SecurityReplayFileResult, Fixnum, Hash)>] SecurityReplayFileResult data, response status code and response headers
    def get_security_replay_file_with_http_info(subsource, date, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['iex', 'utp_delayed', 'cta_a_delayed', 'cta_b_delayed', 'otc_delayed', 'nasdaq_basic', 'cboe_one', 'iex_delayed', 'cboe_one_delayed'].include?(subsource)
        fail ArgumentError, "invalid value for 'subsource', must be one of iex, utp_delayed, cta_a_delayed, cta_b_delayed, otc_delayed, nasdaq_basic, cboe_one, iex_delayed, cboe_one_delayed"
      end
    ...
    def get_security_short_interest(identifier, opts = {})
      data, _status_code, _headers = get_security_short_interest_with_http_info(identifier, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecurityShortInterest, Fixnum, Hash)>] ApiResponseSecurityShortInterest data, response status code and response headers
    def get_security_short_interest_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_short_interest ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling SecurityApi.get_security_short_interest"
      end
      # resource path
      local_var_path = "/securities/{identifier}/short_interest".sub('{' + 'identifier' + '}', identifier.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_short_interest\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [ApiResponseSecurityStockPriceAdjustments]
    def get_security_stock_price_adjustments_dividends(identifier, opts = {})
      data, _status_code, _headers = get_security_stock_price_adjustments_dividends_with_http_info(identifier, opts)
      return data
    end
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecurityStockPriceAdjustments, Fixnum, Hash)>] ApiResponseSecurityStockPriceAdjustments data, response status code and response headers
    def get_security_stock_price_adjustments_dividends_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_stock_price_adjustments_dividends ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling SecurityApi.get_security_stock_price_adjustments_dividends"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 10000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SecurityApi.get_security_stock_price_adjustments_dividends, must be smaller than or equal to 10000.'
      end

      # resource path
      local_var_path = "/securities/{identifier}/prices/adjustments/dividends".sub('{' + 'identifier' + '}', identifier.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ApiResponseSecurityStockPriceAdjustments')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_stock_price_adjustments_dividends\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [ApiResponseSecurityStockPriceAdjustments]
    def get_security_stock_price_adjustments_splits(identifier, opts = {})
      data, _status_code, _headers = get_security_stock_price_adjustments_splits_with_http_info(identifier, opts)
      return data
    end
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(ApiResponseSecurityStockPriceAdjustments, Fixnum, Hash)>] ApiResponseSecurityStockPriceAdjustments data, response status code and response headers
    def get_security_stock_price_adjustments_splits_with_http_info(identifier, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_stock_price_adjustments_splits ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling SecurityApi.get_security_stock_price_adjustments_splits"
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 10000
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling SecurityApi.get_security_stock_price_adjustments_splits, must be smaller than or equal to 10000.'
      end

      # resource path
      local_var_path = "/securities/{identifier}/prices/adjustments/splits".sub('{' + 'identifier' + '}', identifier.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ApiResponseSecurityStockPriceAdjustments')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityApi#get_security_stock_price_adjustments_splits\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [BOOLEAN] :darkpool_only Set to true to show only darkpool trades (default to false)
    ...
    # @option opts [Integer] :min_size Trades must be larger or equal to this size.
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(SecurityTradesResult, Fixnum, Hash)>] SecurityTradesResult data, response status code and response headers
    def get_security_trades_with_http_info(source, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['nasdaq_basic', 'iex', 'cta_a_delayed', 'cta_b_delayed', 'utp_delayed', 'otc_delayed', 'cboe_one_delayed', 'iex_delayed'].include?(source)
        fail ArgumentError, "invalid value for 'source', must be one of nasdaq_basic, iex, cta_a_delayed, cta_b_delayed, utp_delayed, otc_delayed, cboe_one_delayed, iex_delayed"
      end
      if @api_client.config.client_side_validation && opts[:'timezone'] && !['Africa/Algiers', 'Africa/Cairo', 'Africa/Casablanca', 'Africa/Harare', 'Africa/Johannesburg', 'Africa/Monrovia', 'Africa/Nairobi', 'America/Argentina/Buenos_Aires', 'America/Bogota', 'America/Caracas', 'America/Chicago', 'America/Chihuahua', 'America/Denver', 'America/Godthab', 'America/Guatemala', 'America/Guyana', 'America/Halifax', 'America/Indiana/Indianapolis', 'America/Juneau', 'America/La_Paz', 'America/Lima', 'America/Lima', 'America/Los_Angeles', 'America/Mazatlan', 'America/Mexico_City', 'America/Mexico_City', 'America/Monterrey', 'America/Montevideo', 'America/New_York', 'America/Phoenix', 'America/Regina', 'America/Santiago', 'America/Sao_Paulo', 'America/St_Johns', 'America/Tijuana', 'Asia/Almaty', 'Asia/Baghdad', 'Asia/Baku', 'Asia/Bangkok', 'Asia/Bangkok', 'Asia/Chongqing', 'Asia/Colombo', 'Asia/Dhaka', 'Asia/Dhaka', 'Asia/Hong_Kong', 'Asia/Irkutsk', 'Asia/Jakarta', 'Asia/Jerusalem', 'Asia/Kabul', 'Asia/Kamchatka', 'Asia/Karachi', 'Asia/Karachi', 'Asia/Kathmandu', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Krasnoyarsk', 'Asia/Kuala_Lumpur', 'Asia/Kuwait', 'Asia/Magadan', 'Asia/Muscat', 'Asia/Muscat', 'Asia/Novosibirsk', 'Asia/Rangoon', 'Asia/Riyadh', 'Asia/Seoul', 'Asia/Shanghai', 'Asia/Singapore', 'Asia/Srednekolymsk', 'Asia/Taipei', 'Asia/Tashkent', 'Asia/Tbilisi', 'Asia/Tehran', 'Asia/Tokyo', 'Asia/Tokyo', 'Asia/Tokyo', 'Asia/Ulaanbaatar', 'Asia/Urumqi', 'Asia/Vladivostok', 'Asia/Yakutsk', 'Asia/Yekaterinburg', 'Asia/Yerevan', 'Atlantic/Azores', 'Atlantic/Cape_Verde', 'Atlantic/South_Georgia', 'Australia/Adelaide', 'Australia/Brisbane', 'Australia/Darwin', 'Australia/Hobart', 'Australia/Melbourne', 'Australia/Melbourne', 'Australia/Perth', 'Australia/Sydney', 'Etc/UTC', 'UTC', 'Europe/Amsterdam', 'Europe/Athens', 'Europe/Belgrade', 'Europe/Berlin', 'Europe/Berlin', 'Europe/Bratislava', 'Europe/Brussels', 'Europe/Bucharest', 'Europe/Budapest', 'Europe/Copenhagen', 'Europe/Dublin', 'Europe/Helsinki', 'Europe/Istanbul', 'Europe/Kaliningrad', 'Europe/Kiev', 'Europe/Lisbon', 'Europe/Ljubljana', 'Europe/London', 'Europe/London', 'Europe/Madrid', 'Europe/Minsk', 'Europe/Moscow', 'Europe/Moscow', 'Europe/Paris', 'Europe/Prague', 'Europe/Riga', 'Europe/Rome', 'Europe/Samara', 'Europe/Sarajevo', 'Europe/Skopje', 'Europe/Sofia', 'Europe/Stockholm', 'Europe/Tallinn', 'Europe/Vienna', 'Europe/Vilnius', 'Europe/Volgograd', 'Europe/Warsaw', 'Europe/Zagreb', 'Pacific/Apia', 'Pacific/Auckland', 'Pacific/Auckland', 'Pacific/Chatham', 'Pacific/Fakaofo', 'Pacific/Fiji', 'Pacific/Guadalcanal', 'Pacific/Guam', 'Pacific/Honolulu', 'Pacific/Majuro', 'Pacific/Midway', 'Pacific/Midway', 'Pacific/Noumea', 'Pacific/Pago_Pago', 'Pacific/Port_Moresby', 'Pacific/Tongatapu'].include?(opts[:'timezone'])
        fail ArgumentError, 'invalid value for "timezone", must be one of Africa/Algiers, Africa/Cairo, Africa/Casablanca, Africa/Harare, Africa/Johannesburg, Africa/Monrovia, Africa/Nairobi, America/Argentina/Buenos_Aires, America/Bogota, America/Caracas, America/Chicago, America/Chihuahua, America/Denver, America/Godthab, America/Guatemala, America/Guyana, America/Halifax, America/Indiana/Indianapolis, America/Juneau, America/La_Paz, America/Lima, America/Lima, America/Los_Angeles, America/Mazatlan, America/Mexico_City, America/Mexico_City, America/Monterrey, America/Montevideo, America/New_York, America/Phoenix, America/Regina, America/Santiago, America/Sao_Paulo, America/St_Johns, America/Tijuana, Asia/Almaty, Asia/Baghdad, Asia/Baku, Asia/Bangkok, Asia/Bangkok, Asia/Chongqing, Asia/Colombo, Asia/Dhaka, Asia/Dhaka, Asia/Hong_Kong, Asia/Irkutsk, Asia/Jakarta, Asia/Jerusalem, Asia/Kabul, Asia/Kamchatka, Asia/Karachi, Asia/Karachi, Asia/Kathmandu, Asia/Kolkata, Asia/Kolkata, Asia/Kolkata, Asia/Kolkata, Asia/Krasnoyarsk, Asia/Kuala_Lumpur, Asia/Kuwait, Asia/Magadan, Asia/Muscat, Asia/Muscat, Asia/Novosibirsk, Asia/Rangoon, Asia/Riyadh, Asia/Seoul, Asia/Shanghai, Asia/Singapore, Asia/Srednekolymsk, Asia/Taipei, Asia/Tashkent, Asia/Tbilisi, Asia/Tehran, Asia/Tokyo, Asia/Tokyo, Asia/Tokyo, Asia/Ulaanbaatar, Asia/Urumqi, Asia/Vladivostok, Asia/Yakutsk, Asia/Yekaterinburg, Asia/Yerevan, Atlantic/Azores, Atlantic/Cape_Verde, Atlantic/South_Georgia, Australia/Adelaide, Australia/Brisbane, Australia/Darwin, Australia/Hobart, Australia/Melbourne, Australia/Melbourne, Australia/Perth, Australia/Sydney, Etc/UTC, UTC, Europe/Amsterdam, Europe/Athens, Europe/Belgrade, Europe/Berlin, Europe/Berlin, Europe/Bratislava, Europe/Brussels, Europe/Bucharest, Europe/Budapest, Europe/Copenhagen, Europe/Dublin, Europe/Helsinki, Europe/Istanbul, Europe/Kaliningrad, Europe/Kiev, Europe/Lisbon, Europe/Ljubljana, Europe/London, Europe/London, Europe/Madrid, Europe/Minsk, Europe/Moscow, Europe/Moscow, Europe/Paris, Europe/Prague, Europe/Riga, Europe/Rome, Europe/Samara, Europe/Sarajevo, Europe/Skopje, Europe/Sofia, Europe/Stockholm, Europe/Tallinn, Europe/Vienna, Europe/Vilnius, Europe/Volgograd, Europe/Warsaw, Europe/Zagreb, Pacific/Apia, Pacific/Auckland, Pacific/Auckland, Pacific/Chatham, Pacific/Fakaofo, Pacific/Fiji, Pacific/Guadalcanal, Pacific/Guam, Pacific/Honolulu, Pacific/Majuro, Pacific/Midway, Pacific/Midway, Pacific/Noumea, Pacific/Pago_Pago, Pacific/Port_Moresby, Pacific/Tongatapu'
      end
      ...
      query_params[:'timezone'] = opts[:'timezone'] if !opts[:'timezone'].nil?
      query_params[:'page_size'] = opts[:'page_size'] if !opts[:'page_size'].nil?
      query_params[:'darkpool_only'] = opts[:'darkpool_only'] if !opts[:'darkpool_only'].nil?
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [SecurityTradesResult]
    def get_security_trades_by_symbol(identifier, source, opts = {})
      data, _status_code, _headers = get_security_trades_by_symbol_with_http_info(identifier, source, opts)
      return data
    end
    ...
    # @option opts [String] :next_page Gets the next page of data from a previous API call
    # @return [Array<(SecurityTradesResult, Fixnum, Hash)>] SecurityTradesResult data, response status code and response headers
    def get_security_trades_by_symbol_with_http_info(identifier, source, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SecurityApi.get_security_trades_by_symbol ..."
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling SecurityApi.get_security_trades_by_symbol"
      end
      # verify the required parameter 'source' is set
      if @api_client.config.client_side_validation && source.nil?
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['nasdaq_basic', 'delayed_sip', 'iex', 'cta_a_delayed', 'cta_b_delayed', 'utp_delayed', 'otc_delayed', 'cboe_one_delayed', 'iex_delayed'].include?(source)
        fail ArgumentError, "invalid value for 'source', must be one of nasdaq_basic, delayed_sip, iex, cta_a_delayed, cta_b_delayed, utp_delayed, otc_delayed, cboe_one_delayed, iex_delayed"
      end
      if @api_client.config.client_side_validation && opts[:'timezone'] && !['Africa/Algiers', 'Africa/Cairo', 'Africa/Casablanca', 'Africa/Harare', 'Africa/Johannesburg', 'Africa/Monrovia', 'Africa/Nairobi', 'America/Argentina/Buenos_Aires', 'America/Bogota', 'America/Caracas', 'America/Chicago', 'America/Chihuahua', 'America/Denver', 'America/Godthab', 'America/Guatemala', 'America/Guyana', 'America/Halifax', 'America/Indiana/Indianapolis', 'America/Juneau', 'America/La_Paz', 'America/Lima', 'America/Lima', 'America/Los_Angeles', 'America/Mazatlan', 'America/Mexico_City', 'America/Mexico_City', 'America/Monterrey', 'America/Montevideo', 'America/New_York', 'America/Phoenix', 'America/Regina', 'America/Santiago', 'America/Sao_Paulo', 'America/St_Johns', 'America/Tijuana', 'Asia/Almaty', 'Asia/Baghdad', 'Asia/Baku', 'Asia/Bangkok', 'Asia/Bangkok', 'Asia/Chongqing', 'Asia/Colombo', 'Asia/Dhaka', 'Asia/Dhaka', 'Asia/Hong_Kong', 'Asia/Irkutsk', 'Asia/Jakarta', 'Asia/Jerusalem', 'Asia/Kabul', 'Asia/Kamchatka', 'Asia/Karachi', 'Asia/Karachi', 'Asia/Kathmandu', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Kolkata', 'Asia/Krasnoyarsk', 'Asia/Kuala_Lumpur', 'Asia/Kuwait', 'Asia/Magadan', 'Asia/Muscat', 'Asia/Muscat', 'Asia/Novosibirsk', 'Asia/Rangoon', 'Asia/Riyadh', 'Asia/Seoul', 'Asia/Shanghai', 'Asia/Singapore', 'Asia/Srednekolymsk', 'Asia/Taipei', 'Asia/Tashkent', 'Asia/Tbilisi', 'Asia/Tehran', 'Asia/Tokyo', 'Asia/Tokyo', 'Asia/Tokyo', 'Asia/Ulaanbaatar', 'Asia/Urumqi', 'Asia/Vladivostok', 'Asia/Yakutsk', 'Asia/Yekaterinburg', 'Asia/Yerevan', 'Atlantic/Azores', 'Atlantic/Cape_Verde', 'Atlantic/South_Georgia', 'Australia/Adelaide', 'Australia/Brisbane', 'Australia/Darwin', 'Australia/Hobart', 'Australia/Melbourne', 'Australia/Melbourne', 'Australia/Perth', 'Australia/Sydney', 'Etc/UTC', 'UTC', 'Europe/Amsterdam', 'Europe/Athens', 'Europe/Belgrade', 'Europe/Berlin', 'Europe/Berlin', 'Europe/Bratislava', 'Europe/Brussels', 'Europe/Bucharest', 'Europe/Budapest', 'Europe/Copenhagen', 'Europe/Dublin', 'Europe/Helsinki', 'Europe/Istanbul', 'Europe/Kaliningrad', 'Europe/Kiev', 'Europe/Lisbon', 'Europe/Ljubljana', 'Europe/London', 'Europe/London', 'Europe/Madrid', 'Europe/Minsk', 'Europe/Moscow', 'Europe/Moscow', 'Europe/Paris', 'Europe/Prague', 'Europe/Riga', 'Europe/Rome', 'Europe/Samara', 'Europe/Sarajevo', 'Europe/Skopje', 'Europe/Sofia', 'Europe/Stockholm', 'Europe/Tallinn', 'Europe/Vienna', 'Europe/Vilnius', 'Europe/Volgograd', 'Europe/Warsaw', 'Europe/Zagreb', 'Pacific/Apia', 'Pacific/Auckland', 'Pacific/Auckland', 'Pacific/Chatham', 'Pacific/Fakaofo', 'Pacific/Fiji', 'Pacific/Guadalcanal', 'Pacific/Guam', 'Pacific/Honolulu', 'Pacific/Majuro', 'Pacific/Midway', 'Pacific/Midway', 'Pacific/Noumea', 'Pacific/Pago_Pago', 'Pacific/Port_Moresby', 'Pacific/Tongatapu'].include?(opts[:'timezone'])
        fail ArgumentError, 'invalid value for "timezone", must be one of Africa/Algiers, Africa/Cairo, Africa/Casablanca, Africa/Harare, Africa/Johannesburg, Africa/Monrovia, Africa/Nairobi, America/Argentina/Buenos_Aires, America/Bogota, America/Caracas, America/Chicago, America/Chihuahua, America/Denver, America/Godthab, America/Guatemala, America/Guyana, America/Halifax, America/Indiana/Indianapolis, America/Juneau, America/La_Paz, America/Lima, America/Lima, America/Los_Angeles, America/Mazatlan, America/Mexico_City, America/Mexico_City, America/Monterrey, America/Montevideo, America/New_York, America/Phoenix, America/Regina, America/Santiago, America/Sao_Paulo, America/St_Johns, America/Tijuana, Asia/Almaty, Asia/Baghdad, Asia/Baku, Asia/Bangkok, Asia/Bangkok, Asia/Chongqing, Asia/Colombo, Asia/Dhaka, Asia/Dhaka, Asia/Hong_Kong, Asia/Irkutsk, Asia/Jakarta, Asia/Jerusalem, Asia/Kabul, Asia/Kamchatka, Asia/Karachi, Asia/Karachi, Asia/Kathmandu, Asia/Kolkata, Asia/Kolkata, Asia/Kolkata, Asia/Kolkata, Asia/Krasnoyarsk, Asia/Kuala_Lumpur, Asia/Kuwait, Asia/Magadan, Asia/Muscat, Asia/Muscat, Asia/Novosibirsk, Asia/Rangoon, Asia/Riyadh, Asia/Seoul, Asia/Shanghai, Asia/Singapore, Asia/Srednekolymsk, Asia/Taipei, Asia/Tashkent, Asia/Tbilisi, Asia/Tehran, Asia/Tokyo, Asia/Tokyo, Asia/Tokyo, Asia/Ulaanbaatar, Asia/Urumqi, Asia/Vladivostok, Asia/Yakutsk, Asia/Yekaterinburg, Asia/Yerevan, Atlantic/Azores, Atlantic/Cape_Verde, Atlantic/South_Georgia, Australia/Adelaide, Australia/Brisbane, Australia/Darwin, Australia/Hobart, Australia/Melbourne, Australia/Melbourne, Australia/Perth, Australia/Sydney, Etc/UTC, UTC, Europe/Amsterdam, Europe/Athens, Europe/Belgrade, Europe/Berlin, Europe/Berlin, Europe/Bratislava, Europe/Brussels, Europe/Bucharest, Europe/Budapest, Europe/Copenhagen, Europe/Dublin, Europe/Helsinki, Europe/Istanbul, Europe/Kaliningrad, Europe/Kiev, Europe/Lisbon, Europe/Ljubljana, Europe/London, Europe/London, Europe/Madrid, Europe/Minsk, Europe/Moscow, Europe/Moscow, Europe/Paris, Europe/Prague, Europe/Riga, Europe/Rome, Europe/Samara, Europe/Sarajevo, Europe/Skopje, Europe/Sofia, Europe/Stockholm, Europe/Tallinn, Europe/Vienna, Europe/Vilnius, Europe/Volgograd, Europe/Warsaw, Europe/Zagreb, Pacific/Apia, Pacific/Auckland, Pacific/Auckland, Pacific/Chatham, Pacific/Fakaofo, Pacific/Fiji, Pacific/Guadalcanal, Pacific/Guam, Pacific/Honolulu, Pacific/Majuro, Pacific/Midway, Pacific/Midway, Pacific/Noumea, Pacific/Pago_Pago, Pacific/Port_Moresby, Pacific/Tongatapu'
      end
      ...
      # resource path
      local_var_path = "/securities/{identifier}/trades".sub('{' + 'identifier' + '}', identifier.to_s)
    ...
    # @option opts [Integer] :page_size The number of results to return. Maximum for this endpoint is 50000. (default to 100)
