...
module Intrinio
  ...
  class ApiResponseSecurityQuote
    ...
    def hash
      [security, last, last_time, source, open, high, low, exchange_volume, eod_fifty_two_week_high, eod_fifty_two_week_low, marketcap, pricetoearnings, previous_close, previous_close_date, change, change_percent].hash
    end
