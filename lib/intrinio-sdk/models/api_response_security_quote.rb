...
module Intrinio
  ...
  class ApiResponseSecurityQuote
    ...
    def hash
      [security, last, last_time, source, open, high, low, exchange_volume, eod_fifty_two_week_high, eod_fifty_two_week_low, marketcap, pricetoearnings, previous_close, previous_close_date, change, change_percent, adj_close_5_days_ago, adj_close_30_days_ago, adj_close_180_days_ago, adj_close_365_days_ago, adj_close_1825_days_ago, change_percent_5_days, change_percent_30_days, change_percent_180_days, change_percent_365_days, change_percent_1825_days].hash
    end
