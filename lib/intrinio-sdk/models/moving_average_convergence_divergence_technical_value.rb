...
module Intrinio
  ...
  class MovingAverageConvergenceDivergenceTechnicalValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'macd_histogram')
        self.macd_histogram = attributes[:'macd_histogram']
      end

      if attributes.has_key?(:'macd_line')
        self.macd_line = attributes[:'macd_line']
      end

      if attributes.has_key?(:'signal_line')
        self.signal_line = attributes[:'signal_line']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          macd_histogram == o.macd_histogram &&
          macd_line == o.macd_line &&
          signal_line == o.signal_line
    end
    ...
    def hash
      [date_time, macd_histogram, macd_line, signal_line].hash
    end
