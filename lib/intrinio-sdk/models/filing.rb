...
module Intrinio
  ...
  class Filing
    ...
    def hash
      [id, filing_date, accepted_date, period_end_date, report_type, sec_unique_id, filing_url, report_url, instance_url, industry_category, industry_group, word_count, company].hash
    end
