...
module Intrinio
  ...
  class CompanyPublicFloat
    ...
    attr_accessor :public_float_value

    # The public shares for the company.
    attr_accessor :public_float_shares
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'public_float_value')
        self.public_float_value = attributes[:'public_float_value']
      end

      if attributes.has_key?(:'public_float_shares')
        self.public_float_shares = attributes[:'public_float_shares']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          public_float_value == o.public_float_value &&
          public_float_shares == o.public_float_shares
    end
    ...
    def hash
      [date, filing_date, public_float_value, public_float_shares].hash
    end
