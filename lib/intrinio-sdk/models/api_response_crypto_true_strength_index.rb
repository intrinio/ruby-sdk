...
module Intrinio
  # The True Strength Index calculations for the prices of a Crypto Currency Pair
  class ApiResponseCryptoTrueStrengthIndex
    attr_accessor :technicals
    ...
    def self.swagger_types
      {
        :'technicals' => :'Array<TrueStrengthIndexTechnicalValue>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'technicals')
        if (value = attributes[:'technicals']).is_a?(Array)
          self.technicals = value
        end
      end
    ...
    def hash
      [technicals, indicator, pair, exchange, timeframe, next_page].hash
    end
