...
module Intrinio
  ...
  class ApiResponseSecurityStockPrices
    ...
    def self.swagger_types
      {
        :'stock_prices' => :'Array<StockPriceSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stock_prices')
        if (value = attributes[:'stock_prices']).is_a?(Array)
          self.stock_prices = value
        end
      end
    ...
    def hash
      [stock_prices, security, next_page].hash
    end
