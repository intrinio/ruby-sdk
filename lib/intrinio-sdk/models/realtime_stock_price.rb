...
module Intrinio
  ...
  class RealtimeStockPrice
    ...
    def hash
      [last_price, last_time, last_size, bid_price, bid_size, bid_time, ask_price, ask_size, ask_time, open_price, close_price, high_price, low_price, exchange_volume, market_volume, updated_on, source, listing_venue, sales_conditions, quote_conditions, market_center_code, is_darkpool, security].hash
    end
