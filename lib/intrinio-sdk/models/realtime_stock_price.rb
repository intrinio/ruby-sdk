...
module Intrinio
  ...
  class RealtimeStockPrice
    ...
    attr_accessor :eod_close_price

    # The date of the previous trading session's closing price.
    attr_accessor :eod_close_date
    ...
    attr_accessor :normal_market_hours_last_time
    ...
    attr_accessor :normal_market_hours_last_price
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bid_time')
      ...
      if attributes.has_key?(:'ask_time')
      ...
      if attributes.has_key?(:'eod_close_price')
        self.eod_close_price = attributes[:'eod_close_price']
      end

      if attributes.has_key?(:'eod_close_date')
        self.eod_close_date = attributes[:'eod_close_date']
      end

      if attributes.has_key?(:'normal_market_hours_last_time')
        self.normal_market_hours_last_time = attributes[:'normal_market_hours_last_time']
      end

      if attributes.has_key?(:'normal_market_hours_last_price')
        self.normal_market_hours_last_price = attributes[:'normal_market_hours_last_price']
      end

      if attributes.has_key?(:'normal_market_hours_last_size')
        self.normal_market_hours_last_size = attributes[:'normal_market_hours_last_size']
      end

      if attributes.has_key?(:'qualified_last_price')
        self.qualified_last_price = attributes[:'qualified_last_price']
      end

      if attributes.has_key?(:'qualified_last_time')
        self.qualified_last_time = attributes[:'qualified_last_time']
      end

      if attributes.has_key?(:'qualified_last_size')
        self.qualified_last_size = attributes[:'qualified_last_size']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          eod_close_price == o.eod_close_price &&
          eod_close_date == o.eod_close_date &&
          normal_market_hours_last_time == o.normal_market_hours_last_time &&
          normal_market_hours_last_price == o.normal_market_hours_last_price &&
          normal_market_hours_last_size == o.normal_market_hours_last_size &&
          qualified_last_price == o.qualified_last_price &&
          qualified_last_time == o.qualified_last_time &&
          qualified_last_size == o.qualified_last_size &&
          source == o.source &&
    ...
    def hash
      [last_price, last_time, last_size, bid_price, bid_size, bid_time, ask_price, ask_size, ask_time, open_price, close_price, high_price, low_price, exchange_volume, market_volume, updated_on, eod_close_price, eod_close_date, normal_market_hours_last_time, normal_market_hours_last_price, normal_market_hours_last_size, qualified_last_price, qualified_last_time, qualified_last_size, source, listing_venue, sales_conditions, quote_conditions, market_center_code, is_darkpool, security].hash
    end
