...
module Intrinio
  ...
  class RealtimeStockPrice
    ...
    def hash
      [last_price, last_time, bid_price, bid_size, ask_price, ask_size, open_price, high_price, low_price, exchange_volume, market_volume, updated_on, source, security].hash
    end
