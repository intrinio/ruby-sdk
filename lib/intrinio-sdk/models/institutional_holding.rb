...
module Intrinio
  ...
  class InstitutionalHolding
    ...
    def hash
      [cusip, ticker, security_name, security_type, title_of_class, stock_exchange, period_ended, filing_date, value, amount, type, investment_discretion, other_manager, sole_voting_authority, shared_voting_authority, no_voting_authority].hash
    end
