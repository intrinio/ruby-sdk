...
module Intrinio
  ...
  class Beta
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'one_year_beta')
        self.one_year_beta = attributes[:'one_year_beta']
      end

      if attributes.has_key?(:'three_year_beta')
        self.three_year_beta = attributes[:'three_year_beta']
      end

      if attributes.has_key?(:'five_year_beta')
        self.five_year_beta = attributes[:'five_year_beta']
      end

      if attributes.has_key?(:'seven_year_beta')
        self.seven_year_beta = attributes[:'seven_year_beta']
      end

      if attributes.has_key?(:'ten_year_beta')
        self.ten_year_beta = attributes[:'ten_year_beta']
      end
    ...
    def valid?
      period_type_validator = EnumAttributeValidator.new('String', ["weekly", "monthly"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          one_year_beta == o.one_year_beta &&
          three_year_beta == o.three_year_beta &&
          five_year_beta == o.five_year_beta &&
          seven_year_beta == o.seven_year_beta &&
          ten_year_beta == o.ten_year_beta &&
          security == o.security
    end
    ...
    def hash
      [period_type, one_year_beta, three_year_beta, five_year_beta, seven_year_beta, ten_year_beta, security].hash
    end
