...
module Intrinio
  ...
  class ApiResponseCompanyPublicFloatResult
    ...
    def self.swagger_types
      {
        ...
        :'public_floats' => :'Array<CompanyPublicFloat>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'public_floats')
        if (value = attributes[:'public_floats']).is_a?(Array)
          self.public_floats = value
        end
      end
    ...
    def hash
      [next_page, company, public_floats].hash
    end
