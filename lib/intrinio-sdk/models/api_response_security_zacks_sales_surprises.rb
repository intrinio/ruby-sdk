...
module Intrinio
  ...
  class ApiResponseSecurityZacksSalesSurprises
    ...
    def self.swagger_types
      {
        :'sales_surprises' => :'Array<ZacksSalesSurpriseSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sales_surprises')
        if (value = attributes[:'sales_surprises']).is_a?(Array)
          self.sales_surprises = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          sales_surprises == o.sales_surprises &&
          security == o.security &&
    ...
    def hash
      [sales_surprises, security, next_page].hash
    end
