...
module Intrinio
  ...
  class ApiResponseSecurityIntervalPrices
    ...
    def self.swagger_types
      {
        :'intervals' => :'Array<StockPriceInterval>',
    ...
    def valid?
      source_validator = EnumAttributeValidator.new('String', ["realtime", "delayed", "nasdaq_basic", "nasdaq_basic_filtered", "nasdaq_basic_last_sale", "cboe_one", "equities_edge"])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('String', ["realtime", "delayed", "nasdaq_basic", "nasdaq_basic_filtered", "nasdaq_basic_last_sale", "cboe_one", "equities_edge"])
    ...
    def hash
      [intervals, security, source, next_page].hash
    end
