...
module Intrinio
  ...
  class ZacksLongTermGrowthRate
    ...
    attr_accessor :revisions_upward

    # The number of long term growth estimate revisions downward
    attr_accessor :revisions_downward
