...
module Intrinio
  ...
  class ApiResponseStandardizedFinancialsDimensions
    ...
    def self.swagger_types
      {
        :'dimensions' => :'Array<StandardizedFinancialsDimension>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'data_tag')
        self.data_tag = attributes[:'data_tag']
      end
    ...
    def hash
      [dimensions, data_tag, fundamental].hash
    end
