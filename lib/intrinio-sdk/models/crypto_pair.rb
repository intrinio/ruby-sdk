...
module Intrinio
  ...
  class CryptoPair
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'book_depth_available')
        self.book_depth_available = attributes[:'book_depth_available']
      end

      if attributes.has_key?(:'history_available')
        self.history_available = attributes[:'history_available']
      end

      if attributes.has_key?(:'snapshot_available')
        self.snapshot_available = attributes[:'snapshot_available']
      end

      if attributes.has_key?(:'trades_available')
        self.trades_available = attributes[:'trades_available']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          book_depth_available == o.book_depth_available &&
          history_available == o.history_available &&
          snapshot_available == o.snapshot_available &&
          trades_available == o.trades_available
    end
    ...
    def hash
      [name, code, first_price_date, last_price_date, book_depth_available, history_available, snapshot_available, trades_available].hash
    end
