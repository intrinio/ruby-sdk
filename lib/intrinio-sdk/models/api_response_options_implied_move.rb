...
module Intrinio
  ...
  class ApiResponseOptionsImpliedMove
    ...
    attr_accessor :atm_strike

    # The straddle price for the implied move calculation.
    attr_accessor :straddle_price
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'implied_move')
        self.implied_move = attributes[:'implied_move']
      end
      ...
      if attributes.has_key?(:'atm_strike')
        self.atm_strike = attributes[:'atm_strike']
      end

      if attributes.has_key?(:'straddle_price')
        self.straddle_price = attributes[:'straddle_price']
      end
    ...
    def hash
      [implied_move, messages, underlying_price, expiration, atm_strike, straddle_price, symbol].hash
    end
