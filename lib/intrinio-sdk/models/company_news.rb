...
module Intrinio
  ...
  class CompanyNews
    ...
    def hash
      [id, title, publication_date, url, summary, source, company, companies, securities, topics, copyright, language, word_count, spam, business_relevance, article_sentiment, article_sentiment_confidence, issuer, issuer_name, issuer_company, issuer_security].hash
    end
