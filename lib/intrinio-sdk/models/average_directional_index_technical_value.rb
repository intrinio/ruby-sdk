...
module Intrinio
  ...
  class AverageDirectionalIndexTechnicalValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'adx')
        self.adx = attributes[:'adx']
      end

      if attributes.has_key?(:'di_neg')
        self.di_neg = attributes[:'di_neg']
      end

      if attributes.has_key?(:'di_pos')
        self.di_pos = attributes[:'di_pos']
      end
    ...
    def hash
      [date_time, adx, di_neg, di_pos].hash
    end
