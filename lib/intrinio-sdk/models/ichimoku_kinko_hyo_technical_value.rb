...
module Intrinio
  ...
  class IchimokuKinkoHyoTechnicalValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chikou_span')
        self.chikou_span = attributes[:'chikou_span']
      end

      if attributes.has_key?(:'kijun_sen')
        self.kijun_sen = attributes[:'kijun_sen']
      end

      if attributes.has_key?(:'senkou_span_a')
        self.senkou_span_a = attributes[:'senkou_span_a']
      end

      if attributes.has_key?(:'senkou_span_b')
        self.senkou_span_b = attributes[:'senkou_span_b']
      end

      if attributes.has_key?(:'tenkan_sen')
        self.tenkan_sen = attributes[:'tenkan_sen']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          chikou_span == o.chikou_span &&
          kijun_sen == o.kijun_sen &&
          senkou_span_a == o.senkou_span_a &&
          senkou_span_b == o.senkou_span_b &&
          tenkan_sen == o.tenkan_sen
    end
    ...
    def hash
      [date_time, chikou_span, kijun_sen, senkou_span_a, senkou_span_b, tenkan_sen].hash
    end
