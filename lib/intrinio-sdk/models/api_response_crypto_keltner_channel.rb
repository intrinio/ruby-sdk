...
module Intrinio
  # The Keltner Channel calculations for the prices of a Crypto Currency Pair
  class ApiResponseCryptoKeltnerChannel
    ...
    def self.swagger_types
      {
        :'technicals' => :'Array<KeltnerChannelTechnicalValue>',
