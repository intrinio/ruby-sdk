...
module Intrinio
  ...
  class SecurityTrades
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'market_center')
        self.market_center = attributes[:'market_center']
      end
    ...
    def hash
      [symbol, timestamp, price, size, total_volume, market_center, condition, is_darkpool].hash
    end
