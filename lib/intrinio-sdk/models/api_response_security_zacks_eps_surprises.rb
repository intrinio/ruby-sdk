...
module Intrinio
  ...
  class ApiResponseSecurityZacksEPSSurprises
    ...
    def self.swagger_types
      {
        :'eps_surprises' => :'Array<ZacksEPSSurpriseSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eps_surprises')
        if (value = attributes[:'eps_surprises']).is_a?(Array)
          self.eps_surprises = value
        end
      end
    ...
    def hash
      [eps_surprises, security, next_page].hash
    end
