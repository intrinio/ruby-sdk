...
module Intrinio
  ...
  class ZacksTargetPriceConsensus
    ...
    attr_accessor :most_recent_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'most_recent_date')
        self.most_recent_date = attributes[:'most_recent_date']
      end
      ...
      if attributes.has_key?(:'raised')
        self.raised = attributes[:'raised']
      end

      if attributes.has_key?(:'lowered')
        self.lowered = attributes[:'lowered']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total == o.total &&
          most_recent_date == o.most_recent_date &&
          median == o.median &&
          raised == o.raised &&
          lowered == o.lowered &&
          company == o.company
    ...
    def hash
      [ticker, company_name, industry_group_number, high, low, mean, standard_deviation, total, most_recent_date, median, raised, lowered, company].hash
    end
