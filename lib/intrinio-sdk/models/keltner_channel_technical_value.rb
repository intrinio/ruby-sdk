...
module Intrinio
  ...
  class KeltnerChannelTechnicalValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lower_band')
        self.lower_band = attributes[:'lower_band']
      end

      if attributes.has_key?(:'middle_band')
        self.middle_band = attributes[:'middle_band']
      end

      if attributes.has_key?(:'upper_band')
        self.upper_band = attributes[:'upper_band']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lower_band == o.lower_band &&
          middle_band == o.middle_band &&
          upper_band == o.upper_band
    end
    ...
    def hash
      [date_time, lower_band, middle_band, upper_band].hash
    end
